						...
						<form className="form-horizontal">
							...
							<div className="form-group">
								...
								<select
									...
									<option value="Select a value">Select a value</option>
									<option value="good nonprofit">Good Nonprofit</option>
									<option value="gooder nonprofit">Gooder Nonprofit</option>
									<option value="best nonprofit">Best Nonprofit</option>
								</select>
							</div>
